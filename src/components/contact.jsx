    ...
    <div className='py-16'>
       ...
       <div className="text-sm text-[#575455] mb-8">let us know how we can help you</div>
        <div className="flex gap-4 flex-wrap px-8 lg:px-4 items-center justify-center">
            <div className="border border-gray-400 border-opacity-25 p-4  w-full lg:w-48 flex flex-col items-start  gap-4">
            ...
            <div className="border border-opacity-25 p-4  w-full lg:w-48 flex flex-col items-start  gap-4 border-gray-400 ">
